...
const Footer = () => {
  return (
    <footer className="relative text-white overflow-hidden pt-0 -mt-[8.2rem] " id="contact">
      ...
      <div className="relative z-10 px-[4.5rem] pt-[4.5rem] pb-[4.625rem]">
        <div className="flex flex-col items-end mb-[4rem]">
          <Image
            src={SkedaraLogo}
            alt="Skedara"
            className="w-[14.375rem] h-auto pb-[1.5625rem]"
          />
          <p className="max-w-[400px] text-[#D4D0CC] text-[1.125rem] leading-[1.6875rem]">
            On track to achieve ISO 27001, ISO 14001,
          </p>
          <p className="max-w-[400px] text-[#D4D0CC] text-[1.125rem] leading-[1.6875rem] pb-[5.4737rem]">
            and SOC 2 for operational excellence.
          </p>

          <div className="flex justify-center gap-[2.5rem] text-[1rem] text-[#FAFAFA] leading-[3rem] font-medium uppercase mb-[1rem] border-b border-[#FAFAFA]/30 pb-[1.5rem] w-fit">
